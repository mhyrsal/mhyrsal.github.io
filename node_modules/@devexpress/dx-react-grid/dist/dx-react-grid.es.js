              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Container,
                    null,
                    columnChooserItems(columns, hiddenColumns).map(function (item) {
...
var FilteringState = function (_React$PureComponent) {
  ...
  function FilteringState(props) {
    ...
    _this.setColumnFilter = stateHelper.applyFieldReducer.bind(stateHelper, 'filters', setColumnFilter);
    return _this;
  }
  ...
  createClass(FilteringState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Action, { name: 'setColumnFilter', action: this.setColumnFilter })
      );
    }
  }]);
...
var EditingState = function (_React$PureComponent) {
  ...
  function EditingState(props) {
    ...
    _this.startEditRows = stateHelper.applyFieldReducer.bind(stateHelper, 'editingRows', startEditRows);
    _this.stopEditRows = stateHelper.applyFieldReducer.bind(stateHelper, 'editingRows', stopEditRows);

    _this.changeRow = stateHelper.applyFieldReducer.bind(stateHelper, 'changedRows', changeRow);
    _this.cancelChangedRows = stateHelper.applyFieldReducer.bind(stateHelper, 'changedRows', cancelChanges);
    _this.commitChangedRows = function (_ref) {
      var rowIds = _ref.rowIds;

      _this.props.onCommitChanges({
        changed: changedRowsByIds(_this.getState().changedRows, rowIds)
      });
    ...
    _this.deleteRows = stateHelper.applyFieldReducer.bind(stateHelper, 'deletedRows', deleteRows);
    _this.cancelDeletedRows = stateHelper.applyFieldReducer.bind(stateHelper, 'deletedRows', cancelDeletedRows);
  ...
  createClass(EditingState, [{
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var editingRows = nextState.editingRows;
      var onEditingRowsChange = this.props.onEditingRowsChange;

      if (onEditingRowsChange && editingRows !== state.editingRows) {
        onEditingRowsChange(editingRows);
      }

      var changedRows = nextState.changedRows;
      var onChangedRowsChange = this.props.onChangedRowsChange;
      ...
      var deletedRows = nextState.deletedRows;
      var onDeletedRowsChange = this.props.onDeletedRowsChange;
    ...
    value: function render() {
      ...
      var _getState = this.getState(),
          editingRows = _getState.editingRows,
          changedRows = _getState.changedRows,
          addedRows = _getState.addedRows,
          deletedRows = _getState.deletedRows;
...
var GroupingState = function (_React$PureComponent) {
  ...
  function GroupingState(props) {
    ...
    _this.draftGroupingChange = _this.stateHelper.applyReducer.bind(_this.stateHelper, draftGroupingChange);
    _this.cancelGroupingChange = _this.stateHelper.applyReducer.bind(_this.stateHelper, cancelGroupingChange);
  ...
  createClass(GroupingState, [{
    ...
    key: 'groupByColumn',
    value: function groupByColumn$$1(_ref4, getters, actions) {
      var columnName = _ref4.columnName,
          groupIndex = _ref4.groupIndex;

      this.stateHelper.applyReducer(groupByColumn, { columnName: columnName, groupIndex: groupIndex }, function (nextState, state) {
        var grouping = nextState.grouping;
        var prevGrouping = state.grouping;
        var sorting = getters.sorting;
        var setColumnSorting$$1 = actions.setColumnSorting;
...
var SelectionState = function (_React$PureComponent) {
  ...
  function SelectionState(props) {
    ...
    _this.toggleSelection = stateHelper.applyFieldReducer.bind(stateHelper, 'selection', setRowsSelection);
    return _this;
  }
  ...
  createClass(SelectionState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Getter, { name: 'selection', value: new Set(selection) }),
...
var IntegratedSelection = function (_React$PureComponent) {
  ...
  createClass(IntegratedSelection, [{
    key: 'toggleSelectAll',
    value: function toggleSelectAll(select, _ref, _ref2) {
      var selection = _ref.selection;
      var toggleSelection = _ref2.toggleSelection;
    ...
    value: function availableToSelect(_ref3) {
      var rows = _ref3.rows,
    ...
    value: function render() {
      ...
      var allSelectedComputed = function allSelectedComputed(_ref4) {
        var selection = _ref4.selection;
        return allSelected({ selection: selection, availableToSelect: availableToSelect });
      };
      var someSelectedComputed = function someSelectedComputed(_ref5) {
...
var SortingState = function (_React$PureComponent) {
  ...
  function SortingState(props) {
    ...
    _this.setColumnSorting = stateHelper.applyReducer.bind(stateHelper, setColumnSorting);
    return _this;
  }
            ...
            return React.createElement(
              ...
              function (_ref6, _ref7) {
                ...
                return React.createElement(Cell, _extends({}, params, {
                  ...
                  onToggle: function onToggle() {
                    return toggleSelection({ rowIds: [params.tableRow.rowId] });
                  }
                }));
              }
            );
...
var RowDetailState = function (_React$PureComponent) {
  ...
  function RowDetailState(props) {
    ...
    _this.setDetailRowExpanded = stateHelper.applyFieldReducer.bind(stateHelper, 'expandedRows', setDetailRowExpanded);
    return _this;
  }
  ...
  createClass(RowDetailState, [{
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var expandedRows = nextState.expandedRows;
      var onExpandedRowsChange = this.props.onExpandedRowsChange;
    ...
    value: function render() {
      var _getState = this.getState(),
          expandedRows = _getState.expandedRows;
      ...
      return React.createElement(
        ...
        React.createElement(Action, { name: 'setDetailRowExpanded', action: this.setDetailRowExpanded })
      );
    }
  }]);
    ...
    value: function render() {
      ...
      var tableBodyRowsComputed = function tableBodyRowsComputed(_ref2) {
        var tableBodyRows = _ref2.tableBodyRows,
            expandedRows = _ref2.expandedRows;
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref4, _ref5) {
                var expandedRows = _ref4.expandedRows;
                var setDetailRowExpanded$$1 = _ref5.setDetailRowExpanded;
  ...
  createClass(TableGroupRow, [{
    ...
    value: function render() {
      ...
      var tableColumnsComputed = function tableColumnsComputed(_ref2) {
        ...
        return tableColumnsWithGrouping(columns, tableColumns, grouping, draftGrouping$$1, indentColumnWidth, showColumnWhenGroupedGetter(showColumnsWhenGrouped, columnExtensions));
      };
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref3, _ref4) {
                ...
                var setColumnSorting$$1 = _ref4.setColumnSorting,
                    groupByColumn$$1 = _ref4.groupByColumn,
                    changeTableColumnWidths$$1 = _ref4.changeTableColumnWidths,
                    changeDraftTableColumnWidths$$1 = _ref4.changeDraftTableColumnWidths;
                var columnName = params.tableColumn.column.name;
                ...
                return React.createElement(HeaderCell, _extends({}, params, {
                  ...
                  onSort: function onSort(_ref6) {
                    ...
                    return setColumnSorting$$1({ columnName: columnName, direction: direction, keepOther: keepOther });
                  },
                  onGroup: function onGroup() {
                    return groupByColumn$$1({ columnName: columnName });
                  },
                  onWidthChange: function onWidthChange(_ref7) {
                    var shift = _ref7.shift;
                    return changeTableColumnWidths$$1({ shifts: defineProperty({}, columnName, shift) });
                  },
                  onDraftWidthChange: function onDraftWidthChange(_ref8) {
                    var shift = _ref8.shift;
                    return changeDraftTableColumnWidths$$1({ shifts: defineProperty({}, columnName, shift) });
                  }
                }));
              }
            );
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref3, _ref4) {
                ...
                var setColumnFilter$$1 = _ref4.setColumnFilter;
                var columnName = params.tableColumn.column.name;

                var filter = getColumnFilterConfig(filters, columnName);
                var onFilter = function onFilter(config) {
                  return setColumnFilter$$1({ columnName: columnName, config: config });
                };
                return React.createElement(
                  TemplatePlaceholder,
                  {
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref3, _ref4) {
                ...
                var changedRow = isNew ? row : _extends({}, row, getRowChange(changedRows, rowId));
...
var TableColumnResizing = function (_React$PureComponent) {
  ...
  function TableColumnResizing(props) {
    ...
    _this.changeTableColumnWidthsAction = stateHelper.applyReducer.bind(stateHelper, changeTableColumnWidths);

    _this.changeDraftTableColumnWidthsAction = stateHelper.applyReducer.bind(stateHelper, changeDraftTableColumnWidths);
    return _this;
  }
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            function (_ref5, _ref6) {
              ...
              var groupByColumn$$1 = _ref6.groupByColumn,
                  draftGroupingChange$$1 = _ref6.draftGroupingChange,
                  cancelGroupingChange$$1 = _ref6.cancelGroupingChange;
              return React.createElement(Layout, {
                items: groupingPanelItems(columns, draftGrouping$$1),
                draggingEnabled: draggingEnabled,
                onGroup: groupByColumn$$1,
                onDraftGroup: function onDraftGroup(groupingChange) {
                  return draftGroupingChange$$1(groupingChange);
                },
                onCancelDraftGroup: function onCancelDraftGroup() {
                  return cancelGroupingChange$$1();
                },
...
var TableColumnVisibility = function (_React$PureComponent) {
  ...
  function TableColumnVisibility(props) {
    ...
    _this.toggleColumnVisibility = stateHelper.applyFieldReducer.bind(stateHelper, 'hiddenColumns', toggleColumn);
    return _this;
  }
  ...
  createClass(TableColumnVisibility, [{
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var hiddenColumns = nextState.hiddenColumns;
      var onHiddenColumnsChange = this.props.onHiddenColumnsChange;
    ...
    value: function render() {
      ...
      var _getState = this.getState(),
          hiddenColumns = _getState.hiddenColumns;
      ...
      return React.createElement(
        ...
        React.createElement(Getter, { name: 'hiddenColumns', value: hiddenColumns }),
        ...
        React.createElement(
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref2) {
                var columns = _ref2.columns;
                return columns.length === hiddenColumns.length ? React.createElement(EmptyMessage, _extends({
                  getMessage: getMessage
                }, params)) : React.createElement(TemplatePlaceholder, null);
              }
            );
          }
        )
...
var ItemLayout = function (_React$PureComponent) {
  ...
  function ItemLayout() {
    ...
    return possibleConstructorReturn(this, (ItemLayout.__proto__ || Object.getPrototypeOf(ItemLayout)).apply(this, arguments));
  }
      ...
      return draggingEnabled ? React.createElement(
        DragSource,
        {
          getPayload: function getPayload() {
            return [{ type: 'column', columnName: item.column.name }];
          },
          onEnd: onDragEnd
        },
...
var GroupPanelLayout = function (_React$PureComponent) {
  ...
  function GroupPanelLayout(props) {
    ...
    _this.onOver = function (_ref2) {
      ...
      var _this$props = _this.props,
          onDraftGroup = _this$props.onDraftGroup,
    ...
    _this.onLeave = function () {
      var _this$props2 = _this.props,
          onDraftGroup = _this$props2.onDraftGroup,
          items = _this$props2.items;
      var sourceColumnName = _this.state.sourceColumnName;

      var sourceItem = items.filter(function (_ref4) {
  ...
  createClass(GroupPanelLayout, [{
    ...
    value: function resetState() {
      var onCancelDraftGroup = this.props.onCancelDraftGroup;
...
GroupPanelLayout.defaultProps = {
  onGroup: function onGroup() {},
  draggingEnabled: false,
  onDraftGroup: function onDraftGroup() {},
  onCancelDraftGroup: function onCancelDraftGroup() {}
};
