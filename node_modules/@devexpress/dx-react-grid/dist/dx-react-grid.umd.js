              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Container,
                    null,
                    dxGridCore.columnChooserItems(columns, hiddenColumns).map(function (item) {
...
var FilteringState = function (_React$PureComponent) {
  ...
  function FilteringState(props) {
    ...
    _this.setColumnFilter = stateHelper.applyFieldReducer.bind(stateHelper, 'filters', dxGridCore.setColumnFilter);
    return _this;
  }
  ...
  createClass(FilteringState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Action, { name: 'setColumnFilter', action: this.setColumnFilter })
      );
    }
  }]);
...
var EditingState = function (_React$PureComponent) {
  ...
  function EditingState(props) {
    ...
    _this.startEditRows = stateHelper.applyFieldReducer.bind(stateHelper, 'editingRows', dxGridCore.startEditRows);
    _this.stopEditRows = stateHelper.applyFieldReducer.bind(stateHelper, 'editingRows', dxGridCore.stopEditRows);

    _this.changeRow = stateHelper.applyFieldReducer.bind(stateHelper, 'changedRows', dxGridCore.changeRow);
    _this.cancelChangedRows = stateHelper.applyFieldReducer.bind(stateHelper, 'changedRows', dxGridCore.cancelChanges);
    _this.commitChangedRows = function (_ref) {
      var rowIds = _ref.rowIds;

      _this.props.onCommitChanges({
        changed: dxGridCore.changedRowsByIds(_this.getState().changedRows, rowIds)
      });
    ...
    _this.deleteRows = stateHelper.applyFieldReducer.bind(stateHelper, 'deletedRows', dxGridCore.deleteRows);
    _this.cancelDeletedRows = stateHelper.applyFieldReducer.bind(stateHelper, 'deletedRows', dxGridCore.cancelDeletedRows);
...
var GroupingState = function (_React$PureComponent) {
  ...
  function GroupingState(props) {
    ...
    _this.draftGroupingChange = _this.stateHelper.applyReducer.bind(_this.stateHelper, dxGridCore.draftGroupingChange);
    _this.cancelGroupingChange = _this.stateHelper.applyReducer.bind(_this.stateHelper, dxGridCore.cancelGroupingChange);
  ...
  createClass(GroupingState, [{
    ...
    value: function groupByColumn$$1(_ref4, getters, actions) {
      ...
      this.stateHelper.applyReducer(dxGridCore.groupByColumn, { columnName: columnName, groupIndex: groupIndex }, function (nextState, state) {
...
var SelectionState = function (_React$PureComponent) {
  ...
  function SelectionState(props) {
    ...
    _this.toggleSelection = stateHelper.applyFieldReducer.bind(stateHelper, 'selection', dxGridCore.setRowsSelection);
    return _this;
  }
  ...
  createClass(SelectionState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Getter, { name: 'selection', value: new Set(selection) }),
...
var SortingState = function (_React$PureComponent) {
  ...
  function SortingState(props) {
    ...
    _this.setColumnSorting = stateHelper.applyReducer.bind(stateHelper, dxGridCore.setColumnSorting);
    return _this;
  }
...
var RowDetailState = function (_React$PureComponent) {
  ...
  function RowDetailState(props) {
    ...
    _this.setDetailRowExpanded = stateHelper.applyFieldReducer.bind(stateHelper, 'expandedRows', dxGridCore.setDetailRowExpanded);
    return _this;
  }
  ...
  createClass(RowDetailState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Action, { name: 'setDetailRowExpanded', action: this.setDetailRowExpanded })
      );
    }
  }]);
  ...
  createClass(TableGroupRow, [{
    ...
    value: function render() {
      ...
      var tableColumnsComputed = function tableColumnsComputed(_ref2) {
        ...
        return dxGridCore.tableColumnsWithGrouping(columns, tableColumns, grouping, draftGrouping$$1, indentColumnWidth, showColumnWhenGroupedGetter(showColumnsWhenGrouped, columnExtensions));
      };
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref3, _ref4) {
                ...
                var changedRow = isNew ? row : _extends({}, row, dxGridCore.getRowChange(changedRows, rowId));
...
var TableColumnResizing = function (_React$PureComponent) {
  ...
  function TableColumnResizing(props) {
    ...
    _this.changeTableColumnWidthsAction = stateHelper.applyReducer.bind(stateHelper, dxGridCore.changeTableColumnWidths);

    _this.changeDraftTableColumnWidthsAction = stateHelper.applyReducer.bind(stateHelper, dxGridCore.changeDraftTableColumnWidths);
    return _this;
  }
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            function (_ref5, _ref6) {
              ...
              return React.createElement(Layout, {
                items: dxGridCore.groupingPanelItems(columns, draftGrouping$$1),
...
var TableColumnVisibility = function (_React$PureComponent) {
  ...
  function TableColumnVisibility(props) {
    ...
    _this.toggleColumnVisibility = stateHelper.applyFieldReducer.bind(stateHelper, 'hiddenColumns', dxGridCore.toggleColumn);
    return _this;
  }
  ...
  createClass(TableColumnVisibility, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Getter, { name: 'hiddenColumns', value: hiddenColumns }),
            ...
            return React.createElement(
              ...
              function (_ref2) {
                ...
                return columns.length === hiddenColumns.length ? React.createElement(EmptyMessage, _extends({
                  getMessage: getMessage
                }, params)) : React.createElement(dxReactCore.TemplatePlaceholder, null);
              }
            );
          }
        )
...
var GroupPanelLayout = function (_React$PureComponent) {
  ...
  function GroupPanelLayout(props) {
    ...
    _this.onLeave = function () {
      ...
      if (sourceItem && sourceItem.draft === dxGridCore.GROUP_ADD_MODE) {
        _this.resetState();
        return;
      }
      onDraftGroup({
