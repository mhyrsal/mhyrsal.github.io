...
var materialUiIcons = require('material-ui-icons');
...
var ToggleButton = function ToggleButton(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(materialUiIcons.VisibilityOff, null)
    )
  );
};
...
var VirtualTable = function (_React$PureComponent) {
  ...
  function VirtualTable(props) {
    ...
    _this.layoutRenderComponent = dxReactCore.createRenderComponent();
    return _this;
  }
  ...
  createClass(VirtualTable, [{
    ...
    value: function render() {
      ...
      return React.createElement(dxReactGrid.Table, _extends({
        layoutComponent: this.layoutRenderComponent(function (props) {
          return React.createElement(VirtualTableLayout$1, _extends({}, props, {
            height: height,
            estimatedRowHeight: estimatedRowHeight
          }));
        }),
...
var ResizingControlBase = function (_React$PureComponent) {
  ...
  function ResizingControlBase(props) {
    ...
    _this.onResizeUpdate = function (_ref2) {
      var x = _ref2.x;
      var onDraftWidthChange = _this.props.onDraftWidthChange;

      onDraftWidthChange({ shift: x - _this.resizeStartingX });
    };
  ...
  createClass(TableHeaderCellBase, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          onDraftWidthChange = _props.onDraftWidthChange,
          classes = _props.classes,
          getMessage = _props.getMessage,
          tableRow = _props.tableRow,
          className = _props.className,
          onSort = _props.onSort,
          restProps = objectWithoutProperties(_props, ['style', 'column', 'tableColumn', 'showSortingControls', 'sortingDirection', 'showGroupingControls', 'onGroup', 'draggingEnabled', 'resizingEnabled', 'onWidthChange', 'onDraftWidthChange', 'classes', 'getMessage', 'tableRow', 'className', 'onSort']);
